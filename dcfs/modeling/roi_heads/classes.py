...
COCO_NOVEL_IDS = [1, 2, 3, 4, 5, 6, 7, 9, 16, 17, 18, 19, 20, 21, 44, 62, 63, 64, 67, 72]
COCO_BASE_IDS = [8, 10, 11, 13, 14, 15, 22, 23, 24, 25, 27, 28, 31, 32, 33, 34, 35, 36, 37, 38,
...
COCO_BASE_CLASSES = [
    k["name"] for k in COCO_CATEGORIES if k["isthing"] == 1 and k["name"] not in COCO_NOVEL_CLASSES
]
COCO_ALL_CLASSES = [
    k["name"] for k in COCO_CATEGORIES if k["isthing"] == 1
]